...
CONSTRAINT FK_USR_GRPMMBR FOREIGN KEY (USER_ID) REFERENCES PLATFORM_USERS.USER(USER_ID),
CONSTRAINT FK_GRP_GRPMMBR FOREIGN KEY (GROUP_ID) REFERENCES PLATFORM_USERS.GROUP(GROUP_ID)
);
