...
//	    msg.writeTo(out);
	...
	public Boolean send(final EmailInfo emailInfo){
		...
		final AWSCredentials credentials = new BasicAWSCredentials("AKIAJAG7MKC34RXKVJ2Q","54cL0Pdewcsayi9tgabR2MaGDE0zUi9cpxNkw12+");
        
        // Construct an object to contain the recipient address.
        Destination destination = new Destination().withToAddresses(new String[]{emailInfo.getTo()});
        
        // Create the subject and body of the message.
        Content subject = new Content().withData("Testing subject");
