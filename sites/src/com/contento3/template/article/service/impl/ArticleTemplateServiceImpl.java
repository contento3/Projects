...
public class ArticleTemplateServiceImpl implements ArticleTemplateService {
	...
	public List<ArticleTemplateDto> findLatestArticleByCategory(
		...
		return (List<ArticleTemplateDto>) articleTemplateAssembler.assemble(articleService.findLatestArticleByCategory(CollectionUtils.asList(categoryId), siteId, numberOfArticles, null, true));
	}
