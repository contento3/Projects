...
import com.contento3.web.site.listener.DomainDeleteClickListener;
...
public class SiteDomainTableBuilder extends AbstractTableBuilder {
	...
	@Override
	public void assignDataToTable(final Dto dto,final Table siteDomainTable,final IndexedContainer domainsContainer) {
		...
		deleteLink.addListener(new DomainDeleteClickListener(siteDomainDto,contextHelper,deleteLink,siteDomainTable));
		...
		editLink.addListener(new DomainDeleteClickListener(siteDomainDto,contextHelper,deleteLink,siteDomainTable));

	}

	@Override
	public void buildHeader(final Table siteDomainTable,final IndexedContainer domainsContainer) {
	...
	@Override
	public void buildEmptyTable(final IndexedContainer domainsContainer){
