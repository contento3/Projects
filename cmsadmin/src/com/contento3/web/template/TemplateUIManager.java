...
public class TemplateUIManager implements UIManager{
     ...
     */
      ...
      */
      ...
      public void renderTemplateListTab(final VerticalLayout vLayout,final Accordion accordion){
      ...
      public void populateAccordion(final Accordion accordion){
          ...
          final Tab globalTemplatesTab = accordion.addTab(globalTemplateListLayout, "Global Templates", new ExternalResource("images/template.png"));
          ...
          final Collection <TemplateDirectoryDto> globalTemplateDirectoryList =  templateDirectoryService.findRootDirectories(true);
          ...
          final Tab templatesTab = accordion.addTab(templateListLayout, "Templates", new ExternalResource("images/template.png"));
          final Collection <TemplateDirectoryDto> templateDirectoryList =  templateDirectoryService.findRootDirectories(false);
      ...
      public Tree populateTemplateList(final Collection<TemplateDirectoryDto> directoryDtos,final TemplateDirectoryService templateDirectoryService, final boolean isGlobalDir){
                ...
                public AcceptCriterion getAcceptCriterion() {
                	final ServerSideCriterion serverCriteria = new ServerSideCriterion() {
                        ...
                        public boolean accept(DragAndDropEvent dragEvent) {
                        	final String sourceId = dragEvent.getTransferable().getData("itemId").toString();
                        ...
                        try {
                                        ...
                                        Notification.show("Notification","Test description" ,Notification.Type.TRAY_NOTIFICATION);
        ...
        private void addChildrenToSelectedDirectory(final Item parentItem,final TemplateDirectoryService templateDirectoryService,
                                                                                                final HierarchicalContainer templateContainer){
        ...
        private void createTemplateUI(final TemplateDto templateDto,final TemplateDirectoryDto selectedDirectory){
    		...
    		try
    		{
    			listeners.add(new AddTemplateButtonListener(this.helper,form,templateDto));
    		}
            ...
            if (null!=templateDto){
            	form.getTemplateNameTxtFld().setValue(templateDto.getTemplateName());
        	...
        	form.getTemplatePathTxtFld().setValue("/"+buildPath(selectedDirectoryId,selectedDirectory.getDirectoryName()));
            ...
            editorFieldsLayout.setComponentAlignment(form.getIsGlobal(),Alignment.BOTTOM_CENTER);
            ...
            if(templateDto == null){
            	tab2 = templateTab.addTab(mainLayout,"Create template",new ExternalResource("images/template.png"));
            }
            else {
                 tab2 = templateTab.addTab(mainLayout,templateDto.getTemplateName(),new ExternalResource("images/template.png"));
            }
                        ...
                        addButton.addClickListener(new com.vaadin.ui.Button.ClickListener() {
                                ...
                                public void buttonClick(com.vaadin.ui.Button.ClickEvent event) {
                                    ...
                                    if (StringUtils.isEmpty(dirToAdd)) {
                                            Notification.show("Directory name cannot be empty",Notification.Type.TRAY_NOTIFICATION);
                                    }
                                    else if (isSiblingWithSameName && StringUtils.isNotEmpty(dirToAdd)) {
                                            Notification.show("Directory name already exist,please choose something different",Notification.Type.TRAY_NOTIFICATION);
                                    }
                                    else {
                                            ...
                                            if (newDirectory!=null){
                                                    ...
                                                    Notification.show(name.getValue()+" folder added successfully",Notification.Type.TRAY_NOTIFICATION);
                                            }
                                    }
                                }
                        });
